...
# ///
# MAGIC %md
# MAGIC # Tests: Price Paid Data
# MAGIC
# MAGIC Run all after any change to `databricks_src/silver/transforms/ppd.py` or to
...
# MAGIC
# MAGIC Transactions reach both grains. They set `has_price` on the small-area dimension and carry every price measure, aggregated to published area at three cuts and to small area annually.
# MAGIC
