...
# ///
# MAGIC %md
# MAGIC # Tests: Street-level crime
# MAGIC
# MAGIC Run all after any change to `databricks_src/silver/transforms/police.py` or to
...
# MAGIC
# MAGIC Crime drives two dimensions and four facts. It sets the published type vocabulary outright, and its small-area codes are most of what `dim_lsoa` covers, including the codes exclusive to the 2011 boundaries that carry no price.
# MAGIC
...
# MAGIC
# MAGIC This cell is repeated in each notebook rather than imported. Importing
...
# MAGIC
# MAGIC Six tables read this source, and Some don't have a transform yet.
# MAGIC
